"""Модуль, обучающий нейросеть."""

import numpy as np


def network_fitting(best_network, inputs, outputs, max_epochs, print_number):
    """Реализует процесс обучения нейросети генетическим алгоритмом.

    Параметры:
    best_network - объект нейросети;
    inputs, outputs - входы и выходы нейросети;
    max_epochs - максимальное число эпох обучения;
    print_number - число эпох, через которое нужно выводить результат.
    """
    best_cost = 1000000
